...
namespace rail
{
	public class IRailUserSpaceHelperImpl : RailObject, IRailUserSpaceHelper
	{
		...
		{
			IntPtr intPtr = (options != null) ? RAIL_API_PINVOKE.new_RailQueryWorkFileOptions__SWIG_0() : IntPtr.Zero;
			if (options != null)
			{
		...
		{
			IntPtr intPtr = (filter != null) ? RAIL_API_PINVOKE.new_RailSpaceWorkFilter__SWIG_0() : IntPtr.Zero;
			if (filter != null)
			{
				RailConverter.Csharp2Cpp(filter, intPtr);
			}
			IntPtr intPtr2 = (options != null) ? RAIL_API_PINVOKE.new_RailQueryWorkFileOptions__SWIG_0() : IntPtr.Zero;
			if (options != null)
			{
		...
		{
			IntPtr intPtr = (!(id == null)) ? RAIL_API_PINVOKE.new_SpaceWorkID__SWIG_0() : IntPtr.Zero;
			if (id != null)
			{
			...
			try
			{
				...
				return (!(intPtr2 == IntPtr.Zero)) ? new IRailSpaceWorkImpl(intPtr2) : null;
			}
			finally
			{
		...
		public virtual IRailSpaceWork CreateSpaceWork(EnumRailSpaceWorkType type)
		{
			...
			return (!(intPtr == IntPtr.Zero)) ? new IRailSpaceWorkImpl(intPtr) : null;
		}
		...
		{
			IntPtr intPtr = (result != null) ? RAIL_API_PINVOKE.new_QueryMySubscribedSpaceWorksResult__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (filter != null) ? RAIL_API_PINVOKE.new_RailSpaceWorkSearchFilter__SWIG_0() : IntPtr.Zero;
			if (filter != null)
			{
				RailConverter.Csharp2Cpp(filter, intPtr);
			}
			...
			IntPtr intPtr3 = (types != null) ? RAIL_API_PINVOKE.new_RailArrayEnumRailSpaceWorkType__SWIG_0() : IntPtr.Zero;
			if (types != null)
			{
