...
namespace rail
{
	public class IRailHttpSessionImpl : RailObject, IRailHttpSession, IRailComponent
	{
		...
		{
			IntPtr intPtr = (parameters != null) ? RAIL_API_PINVOKE.new_RailArrayRailKeyValue__SWIG_0() : IntPtr.Zero;
			if (parameters != null)
			{
		...
		{
			IntPtr intPtr = (headers != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			if (headers != null)
			{
