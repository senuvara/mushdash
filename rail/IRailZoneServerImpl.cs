...
namespace rail
{
	public class IRailZoneServerImpl : RailObject, IRailZoneServer, IRailComponent
	{
		...
		{
			IntPtr intPtr = (server_addresses != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (zone_ids != null) ? RAIL_API_PINVOKE.new_RailArrayRailZoneID__SWIG_0() : IntPtr.Zero;
			try
			{
