...
namespace rail
{
	public class IRailGameImpl : RailObject, IRailGame
	{
		...
		{
			IntPtr intPtr = (language_codes != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (game_playing_states != null) ? RAIL_API_PINVOKE.new_RailArrayRailGameDefineGamePlayingState__SWIG_0() : IntPtr.Zero;
		...
		{
			IntPtr intPtr = (branch_info != null) ? RAIL_API_PINVOKE.new_RailBranchInfo__SWIG_0() : IntPtr.Zero;
			try
			{
