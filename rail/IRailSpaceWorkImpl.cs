...
namespace rail
{
	public class IRailSpaceWorkImpl : RailObject, IRailSpaceWork, IRailComponent
	{
		...
		{
			IntPtr intPtr = (progress != null) ? RAIL_API_PINVOKE.new_RailSpaceWorkSyncProgress__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (tags != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (metadata != null) ? RAIL_API_PINVOKE.new_RailArrayRailKeyValue__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (preview_urls != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (ids != null) ? RAIL_API_PINVOKE.new_RailArraySpaceWorkID__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (languages != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (local_paths != null) ? RAIL_API_PINVOKE.new_RailArrayRailString__SWIG_0() : IntPtr.Zero;
			if (local_paths != null)
			{
		...
		{
			IntPtr intPtr = (vote_details != null) ? RAIL_API_PINVOKE.new_RailArrayRailSpaceWorkVoteDetail__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (uploader_ids != null) ? RAIL_API_PINVOKE.new_RailArrayRailID__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (options != null) ? RAIL_API_PINVOKE.new_RailSpaceWorkUpdateOptions__SWIG_0() : IntPtr.Zero;
			if (options != null)
			{
		...
		{
			IntPtr intPtr = (game_ids != null) ? RAIL_API_PINVOKE.new_RailArrayRailGameID__SWIG_0() : IntPtr.Zero;
			if (game_ids != null)
			{
