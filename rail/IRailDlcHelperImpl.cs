...
namespace rail
{
	public class IRailDlcHelperImpl : RailObject, IRailDlcHelper
	{
		...
		{
			IntPtr intPtr = (dlc_ids != null) ? RAIL_API_PINVOKE.new_RailArrayRailDlcID__SWIG_0() : IntPtr.Zero;
			if (dlc_ids != null)
			{
		...
		{
			IntPtr intPtr = (!(dlc_id == null)) ? RAIL_API_PINVOKE.new_RailDlcID__SWIG_0() : IntPtr.Zero;
			if (dlc_id != null)
			{
		...
		{
			IntPtr intPtr = (dlc_info != null) ? RAIL_API_PINVOKE.new_RailDlcInfo__SWIG_0() : IntPtr.Zero;
			try
			{
