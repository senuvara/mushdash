...
namespace rail
{
	public class IRailRoomImpl : RailObject, IRailRoom, IRailComponent
	{
		...
		{
			IntPtr intPtr = (!(new_owner_id == null)) ? RAIL_API_PINVOKE.new_RailID__SWIG_0() : IntPtr.Zero;
		...
		{
			IntPtr intPtr = (!(member_id == null)) ? RAIL_API_PINVOKE.new_RailID__SWIG_0() : IntPtr.Zero;
			if (member_id != null)
			{
		...
		public virtual RailResult AsyncSetMemberMetadata(RailID member_id, List<RailKeyValue> key_values, string user_data)
		{
			...
			IntPtr intPtr2 = (key_values != null) ? RAIL_API_PINVOKE.new_RailArrayRailKeyValue__SWIG_0() : IntPtr.Zero;
			if (key_values != null)
			{
		...
		{
			IntPtr intPtr = (!(game_server_rail_id == null)) ? RAIL_API_PINVOKE.new_RailID__SWIG_0() : IntPtr.Zero;
