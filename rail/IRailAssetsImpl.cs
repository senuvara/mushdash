...
namespace rail
{
	public class IRailAssetsImpl : RailObject, IRailAssets, IRailComponent
	{
		...
		{
			IntPtr intPtr = (asset_info != null) ? RAIL_API_PINVOKE.new_RailAssetInfo__SWIG_0() : IntPtr.Zero;
			try
			{
		...
		{
			IntPtr intPtr = (asset_property_list != null) ? RAIL_API_PINVOKE.new_RailArrayRailAssetProperty__SWIG_0() : IntPtr.Zero;
		...
		{
			IntPtr intPtr = (assets != null) ? RAIL_API_PINVOKE.new_RailArrayRailAssetItem__SWIG_0() : IntPtr.Zero;
			if (assets != null)
			{
		...
		{
			IntPtr intPtr = (old_assets != null) ? RAIL_API_PINVOKE.new_RailArrayRailAssetItem__SWIG_0() : IntPtr.Zero;
			if (old_assets != null)
			{
				RailConverter.Csharp2Cpp(old_assets, intPtr);
			}
			IntPtr intPtr2 = (to_product_info != null) ? RAIL_API_PINVOKE.new_RailProductItem__SWIG_0() : IntPtr.Zero;
		...
		{
			IntPtr intPtr = (source_assets != null) ? RAIL_API_PINVOKE.new_RailArrayRailAssetItem__SWIG_0() : IntPtr.Zero;
		...
		{
			IntPtr intPtr = (assets != null) ? RAIL_API_PINVOKE.new_RailArrayuint64_t__SWIG_0() : IntPtr.Zero;
			if (assets != null)
			{
				RailConverter.Csharp2Cpp(assets, intPtr);
			}
		...
		{
			IntPtr intPtr = (!(assets_owner == null)) ? RAIL_API_PINVOKE.new_RailID__SWIG_0() : IntPtr.Zero;
			if (assets_owner != null)
			{
				RailConverter.Csharp2Cpp(assets_owner, intPtr);
			}
			IntPtr intPtr2 = (assets_info != null) ? RAIL_API_PINVOKE.new_RailArrayRailAssetInfo__SWIG_0() : IntPtr.Zero;
			try
			{
