...
namespace Discord
{
	public class AchievementManager
	{
		...
		private static void SetUserAchievementCallbackImpl(IntPtr ptr, Result result)
		{
			...
			SetUserAchievementHandler setUserAchievementHandler = (SetUserAchievementHandler)gCHandle.Target;
			gCHandle.Free();
		...
		{
			GCHandle gCHandle = GCHandle.FromIntPtr(ptr);
			FetchUserAchievementsHandler fetchUserAchievementsHandler = (FetchUserAchievementsHandler)gCHandle.Target;
			gCHandle.Free();
